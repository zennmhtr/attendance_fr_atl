...
class dashboardController extends Controller
{
    public function index()
    {
        ...
        // Data event untuk kalender
        $events = Event::all()->map(function($event) {
            return [
                'title' => '$event->title',
                'start' => $event->start_date, // pastikan sesuai dengan format datetime yang diharapkan FullCalendar
                'end'   => $event->end_date,
            ];
            return view('layouts.dashboard', compact('events'));
        });
