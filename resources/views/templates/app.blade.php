    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                ...
                <li class="{{ Request::is('pegawai*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/pegawai') }}"><i
                        class="icon-user-fill"></i> Kontak</a> </li>
                <li class="{{ Request::is('my-profile*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/my-profile') }}"><i
                            class="icon-user-outline"></i> Profil</a> </li>
            </ul>
        </div>
    </div>
            ...
            <div class="panel-body">
                <div class="tf-container">
                    <div class="box-content">
                        ...
                        <ul class="box-nav">
                            <li class="nav-title">Menu App</li>
                            <li>
                            ...
                            <li>
                                <a href="{{ url('/my-profile') }}" class="nav-link">
                                    ...
                                    <span style="{{ Request::is('my-profile*') ? 'color: blue' : '' }}">Profil Karyawan</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/pegawai') }}" class="nav-link">
                                    <i class="fas fa-users" style="{{ Request::is('pegawai*') ? 'color: blue' : 'color: black' }}"></i>
                                    <span style="{{ Request::is('pegawai*') ? 'color: blue' : '' }}">Karyawan</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ url('/my-absen') }}" class="nav-link">
                                    ...
                                    <span style="{{ Request::is('my-absen*') ? 'color: blue' : '' }}">Data Absensi Karyawan</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/request-location') }}" class="nav-link">
                                    ...
                                    <span style="{{ Request::is('request-location*') ? 'color: blue' : '' }}">Permintaan Lokasi</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ url('/notifications') }}" class="nav-link">
                                    ...
                                    <span style="{{ Request::is('notifications*') ? 'color: blue' : '' }}">Notifikasi</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/logout') }}" class="nav-link" onclick="return confirm('Are You Sure?')">
                                    ...
                                    <span style="{{ Request::is('logout*') ? 'color: blue' : '' }}">Logout</span>
                                </a>
                            </li>
                        </ul>
                    </div>
