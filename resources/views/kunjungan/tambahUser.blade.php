            ...
            <div class="tf-balance-box">
                    <form method="post" class="tf-form p-2" action="{{ url('/kunjungan/store') }}" enctype="multipart/form-data">
                        ...
                        <div class="group-input">
                            ...
                            <input type="text" class="clockpicker @error('visit_in') is-invalid @enderror" id="visit_in" name="visit_in" value="{{ old('visit_in') }}">
                            @error('visit_in')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="group-input">
                            ...
                            <input type="text" class="clockpicker @error('visit_out') is-invalid @enderror" id="visit_out" name="visit_out" value="{{ old('visit_out') }}">
                            @error('visit_out')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="group-input">
                            ...
                            <textarea name="keterangan" id="keterangan" class="@error('keterangan') is-invalid @enderror" cols="30" rows="10">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
