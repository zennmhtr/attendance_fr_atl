                ...
                <form method="post" class="p-4" action="{{ url('/kunjungan/store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control clockpicker @error('visit_in') is-invalid @enderror" id="visit_in" name="visit_in" value="{{ old('visit_in') }}">
                            @error('visit_in')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control clockpicker @error('visit_out') is-invalid @enderror" id="visit_out" name="visit_out" value="{{ old('visit_out') }}">
                            @error('visit_out')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" cols="30" rows="10">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
