                            ...
                            <tbody>
                                @foreach ($data_user as $du)
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action"> 
                                                <li class="edit me-2"><a href="{{ url('/pegawai/detail/'.$du->id) }}" title="Edit Data Karyawan"><i class="icon-pencil-alt"></i></a></li>
                                                ...
                                                <li class="me-2"> <a href="{{ url('/pegawai/shift/'.$du->id) }}" title="Input Jadwal Karyawan"><i style="color:coral" class="fa fa-solid fa-clock"></i></a></li>
