                ...
                <form method="post" action="{{ url('/rekap-data/payroll/tambah') }}" enctype="multipart/form-data" class="p-4">
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            <div class="card p-4">
                                @php
                                    $total_reimbursement = $user->reimbursement->whereBetween('tanggal', [$tanggal_mulai, $tanggal_akhir])->where('status', 'Approved')->sum('jumlah');
                                @endphp
                        ...
                        <div class="col mb-4">
                            <div class="card p-4">
                                ...
                                $total_alfa = $interval->days + 1 - $jumlah_hadir - $cuti - $izin_masuk - $libur;
                                @endphp
